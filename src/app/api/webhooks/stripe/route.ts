...
// Identity verification is handled by the dedicated /api/webhooks/kyc endpoint (src/lib/kyc,
// processKycWebhook) via the provider-agnostic KycProvider adapter — not here. Stripe Identity events
// are configured to deliver to that endpoint (its own signing secret, STRIPE_IDENTITY_WEBHOOK_SECRET),
// separate from this payments/Connect endpoint.
