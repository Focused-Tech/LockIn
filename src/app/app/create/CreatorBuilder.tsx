      ...
      <div id="body">
        ...
        <div className={`pane${paneOn("pRules") ? " on" : ""}`} id="pRules">
          ...
          <div className="blk">
            ...
            <div className="rule"><span className="m yes">✓</span><span><b>One pot per slate.</b> Players enter what they want; what they collect follows their entry and how much they got right.</span></div>
        ...
        <div className={`pane${paneOn("p4") ? " on" : ""}`} id="p4">
          <h2>Set the prize</h2>
          <p className="hint">Players enter what they want into one pot. Your host fee is the only number you control.</p>
          <div className="blk">
          ...
          <div className="blk">
            <div className="lb">Entry sizes you allow <i></i></div>
