...
/**
 * LEGACY — the residence perjury attestation predates this gate (isRealMoneyEligible /
 * evaluatePaidEntry check jurisdiction + age + KYC only; neither reads this). Kept only because
 * acceptCashAttestation (src/app/app/slate/[id]/actions.ts) and its UI (wallet, SlatePicker,
 * DemoSlatePlayer) still write/display it. Not part of the real-money gate — do not wire it back in.
 */
