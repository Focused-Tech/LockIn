...
export const TIMERS = {
  ...
  questionBossFox: 12,
  discardDecision: 60,   // keep/redeal decision window (§2.4: 40 → 60 for reading + deciding; PAUSES while a card is open full screen). Separate from the answering clock. Architect will tune.
} as const;
